...
from cpfl.core.datasets.Partitioner import DataPartitioner, KShardDataPartitioner, DirichletDataPartitioner
...
class CIFAR100(Dataset):
    """
    Class for the CIFAR100 dataset
    """
    ...
    def test(self, model, device_name: str = "cpu"):
        ...
        self.logger.debug("Device for CIFAR100 accuracy check: %s", device)
